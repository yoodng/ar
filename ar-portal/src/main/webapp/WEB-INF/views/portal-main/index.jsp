...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active"><img src="${pageContext.request.contextPath}/assets/images/school/snut.jpg"></div>
        <%--&lt;%&ndash;<div class="item"><img src="${pageContext.request.contextPath}/assets/images/school/yd-south.jpg"></div>&ndash;%&gt;--%>
        <%--<div class="item"><img src="${pageContext.request.contextPath}/assets/images/school/snut.jpg"></div>--%>
        <%--<div class="item"><img src="${pageContext.request.contextPath}/assets/images/school/snut.jpg"></div>--%>
        <%--<div class="item"><img src="${pageContext.request.contextPath}/assets/images/school/snut.jpg"></div>--%>
    </div>
    <!-- 轮播（Carousel）导航 -->
